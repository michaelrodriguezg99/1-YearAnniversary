...
const CAPTCHA_POOL = [
  ...
  { src: "BabyMiko.jpg", label: "BabyMiko", effect: "thunder",
    caption: "Change. ⚡" },
  { src: "Garret.jpg", label: "Garret", effect: "thunder",
    caption: "Change ⚡" },
     { src: "Allie.jpg", label: "Allie",
    caption: "Change." },
  { src: "Dean.jpg", label: "Dean", effect: "thunder",
    caption: "Test. ⚡" },
  { src: "AlistorDemon.jpg", label: "AlistorDemon", effect: "thunder",
    caption: "Change ⚡" },
     { src: "AlistorHuman.jpg", label: "AlisterHuman",
    caption: "Change" },
  { src: "Charry.jpg", label: "Cherry", effect: "thunder",
    caption: "Change. ⚡" },
  { src: "RawAlejanddro.jpg", label: "RawAlejanddro", effect: "thunder",
    caption: "Change" },
     { src: "TaylorSwift.jpg", label: "TaylorSwift",
    caption: "Change" },
  { src: "Antony.jpg", label: "Antony", effect: "thunder",
    caption: "Change" },
  { src: "Benedit.jpg", label: "Benedit", effect: "thunder",
    caption: "Change" },
     { src: "Colin.jpg", label: "Colin",
    caption: "Change" },
  { src: "HitachiinTwins.jpg", label: "HitachiinTwins", effect: "thunder",
    caption: "Change" },
  { src: "Tamiki.jpg", label: "Tamiki", effect: "thunder",
    caption: "Change" },
];
