...
const SCREENS = [
  ...
  { id: "trip-screen",     init: initTrip, onShow: showTrip },
...
const VOICE_QUOTES = {
  ...
  chars: {
    Cassian: { emoji: "🗡️", scenes: [
      { label: "I have no regrets…", src: "cassian_1.mp3" },
      { label: "Keep reaching…", src: "cassian_2.mp3" },
      { label: "Come on…", src: "cassian_3.mp3" },
      { label: "I'll be with you every step…", src: "cassian_4.mp3" },
      { label: "Whatever you need to throw…", src: "cassian_5.mp3" },
    ]},
    Rhysand: { emoji: "🦇", scenes: [
      { label: "Hello…", src: "rhysand_1.mp3" },
    ...
    Xaden: { emoji: "⚡", scenes: [
      { label: "There is nowhere…", src: "xaden_1.mp3" },
      { label: "I would rather…", src: "xaden_2.mp3" },
      { label: "My house…", src: "xaden_3.mp3" },
      { label: "What am I…", src: "xaden_4.mp3" },
      { label: "Did you enjoy…", src: "xaden_5.mp3" },
      { label: "My control when…", src: "xaden_6.mp3" },
      { label: "YES, love…", src: "xaden_7.mp3" },
      { label: "And which god…", src: "xaden_8.mp3" },
      { label: "Going for blood…", src: "xaden_9.mp3" },
    ]},
  },
};
...
/* =====================================================================
   ...
   ---------------------------------------------------------------------
   ✏️  TRIP_DATES is the ONLY accepted reservation: she taps a check-in and
   a check-out and must land on exactly this range (Nov 7 → Nov 9, 2026).
